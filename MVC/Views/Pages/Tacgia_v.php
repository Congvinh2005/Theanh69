...
<body>
    <main class="card" role="main">
        ...
        <form method="post" id="authorForm" novalidate action="http://localhost/QUANLYTHUVIEN/Tacgia/ins">
            <div>
            ...
            <div>
                ...
                <input type="date" id="dob" name="txtNgaysinh" required value="<?php echo $data['ns'] ?? '' ?>" />
            </div>
            ...
            <div>
                ...
                <select id="gender" name="ddlGioitinh" required>
                    ...
                    <option value="male" <?php echo (isset($data['gt']) && $data['gt'] == 'male') ? 'selected' : ''; ?>>
                        Nam</option>
                    <option value="female"
                        <?php echo (isset($data['gt']) && $data['gt'] == 'female') ? 'selected' : ''; ?>>Nữ</option>
                    <option value="other"
                        <?php echo (isset($data['gt']) && $data['gt'] == 'other') ? 'selected' : ''; ?>>Khác</option>
                </select>
            </div>
            ...
            <div>
                ...
                <input type="tel" id="phone" name="txtDienthoai" placeholder="Ví dụ: 0912345678"
                    pattern="[0-9+\- ]{7,20}" required value="<?php echo $data['dt'] ?? '' ?>" />
            ...
            <div class="full">
                ...
                <textarea id="address" name="txtDiachi"
                    placeholder="Nhập địa chỉ nơi cư trú..."><?php echo $data['dc'] ?? '' ?></textarea>
            </div>
            <div class="actions">
